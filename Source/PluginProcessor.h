...
/**
*/
class ReverbAlgorithm1AudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    ReverbAlgorithm1AudioProcessor();
    ~ReverbAlgorithm1AudioProcessor() override;
...
private:
    ...
    const float startingDelayAmount = 0.01f;
